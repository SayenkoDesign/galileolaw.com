    ...
    <div class="container">
        <div class="row">
            <div class=" col-sm-9 gray-bg">
                            ...
                            <div class="col-sm-6">
                                <div class="embed-container blog_image">
                                    <?php if (get_field('youtubevideo') != "") { ?>
                                        <iframe src="http://www.youtube.com/embed/<?php the_field('youtubevideo'); ?>"
                                                frameborder="0" style="width:100%; height:210px"></iframe>
                                ...
                                <a href="<?php the_permalink() ?>" rel="bookmark"
                                   title="Permanent Link to <?php the_title_attribute(); ?>"><span>READ MORE ></span></a>
                            </div>
                        <?php endwhile;
                        endif; ?>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="navigation pagination"><p><?php posts_nav_link(); ?></p></div>
                    </div>
                </div>
            </div>
            <?php get_sidebar(); ?>
